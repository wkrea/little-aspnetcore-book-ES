...
NuGet es a la vez, gestor de paquetes y repositorio de paquetes oficial (en https://www.nuget.org). De forma que con els puedes buscar paquetes en la web, e instalarlos desde tu máquina local a través de la terminal (o Interfaz gráfica, si estas usando Visual Studio).
